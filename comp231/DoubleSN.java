...
public class DoubleSN {
	...
	public DoubleSN reverse(){
		DNode tmp=head;
		DoubleSN  tmp1=new DoubleSN();
		while(tmp!=null){
	...
	public static void main(String[] args) {
		...
		Date firstTime ;
		Date secondTime ;
		DoubleSN ornek=new DoubleSN();
		DoubleSN ornek_10=new DoubleSN();
		DoubleSN ornek_50=new DoubleSN();
		DoubleSN ornek_100=new DoubleSN();
		DoubleSN ornek_500=new DoubleSN();
		DoubleSN ornek_1000=new DoubleSN();
		DoubleSN ornek_5000=new DoubleSN();
		DoubleSN ornek_10000=new DoubleSN();
		DoubleSN ornek_50000=new DoubleSN();
		DoubleSN ornek_100000=new DoubleSN();
		firstTime= new Date(); 
		for(int i=0;i<10;i++){
