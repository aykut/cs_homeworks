...
public class DoubleUN {
	...
	public DoubleUN reverse(){
		DNode tmp=head;
		DoubleUN  tmp1=new DoubleUN();
		while(tmp!=null){
			tmp1.cons(tmp.data);
			tmp=tmp.next;
		}return tmp1;
	...
	public static void main(String[] args) {
		...
		System.out.println("DOUBLE UNSORTED NOT CIRCULAR");
		long tmp;
		Date firstTime ;
		Date secondTime ;
		DoubleUN ornek=new DoubleUN();
		DoubleUN ornek_10=new DoubleUN();
		DoubleUN ornek_50=new DoubleUN();
		DoubleUN ornek_100=new DoubleUN();
		DoubleUN ornek_500=new DoubleUN();
		DoubleUN ornek_1000=new DoubleUN();
		DoubleUN ornek_5000=new DoubleUN();
		DoubleUN ornek_10000=new DoubleUN();
		DoubleUN ornek_50000=new DoubleUN();
		DoubleUN ornek_100000=new DoubleUN();
		firstTime= new Date(); 
		for(int i=0;i<10;i++){
