...
public class SingleSC {
	...
	public SingleSC reverse(){
		Node tmp=head;
		SingleSC tmp1=new SingleSC();
		while(tmp.next!=head){
	...
	public static void main(String[] args) {
		...
		System.out.println("SÝNGLE SORTED CIRCULAR");
		long tmp;
		Date firstTime ;
		Date secondTime ;
		SingleSC ornek=new SingleSC();
		SingleSC ornek_10=new SingleSC();
		SingleSC ornek_50=new SingleSC();
		SingleSC ornek_100=new SingleSC();
		SingleSC ornek_500=new SingleSC();
		SingleSC ornek_1000=new SingleSC();
		SingleSC ornek_5000=new SingleSC();
		SingleSC ornek_10000=new SingleSC();
		SingleSC ornek_50000=new SingleSC();
		SingleSC ornek_100000=new SingleSC();
		firstTime= new Date(); 
		for(int i=0;i<10;i++){
